...
> **选择适合你平台策略的版本**  
> `autojs6-dev-tools-plus` 是面向 Windows 与 macOS 的跨平台增强版。  
> 如果你更需要 Windows 原生高性能版，请参阅 [`autojs6-dev-tools`](https://github.com/terwer/autojs6-dev-tools)。  
